    ...
    <div class="main-panel" style="padding: 1rem; height: 100%;">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        ...
        <div class="" style="display: flex; justify-content: flex-start;align-items: center; width: 100%;margin-top: 5rem; margin-bottom: 1rem; flex-direction: column;">
          ...
          <h5 style="width: 100%;">Category Information</h5>
          ...
          <div class="panel-body p-20" style="width: 100%; display: flex; flex-direction: column;">
  ...
  <!-- ========== COMMON JS FILES ========== -->
    ...
    <script>
        $(function($) {
            ...
            $('#example3').DataTable();
            $('#example3_wrapper').css("display", "flex");
            $('#example3_wrapper').css("flex-direction", "column");
