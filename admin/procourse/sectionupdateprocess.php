<?php 
    ...
    $sql = "UPDATE tb_procourse_section 
            SET courseSec_date='$secdate', courseSec_loc='$seclocation', courseSec_courseID='$secprocourse', courseSec_fac='$secfacilitator', courseSec_seat='$secseat', courseSec_maxseat='$secmaxseat'
