            ...
            if (isset($_POST['save'])) {
                ...
                $phase_id = $_POST['phase'];
                  if($kolej_id > 0 && $phase_id > 0){
                    $query = mysqli_query($con,"SELECT * FROM tb_hostel_reg INNER JOIN tb_hos_college ON tb_hostel_reg.hostel_id = tb_hos_college.kolej_id WHERE tb_hostel_reg.hostel_id = '$kolej_id' AND tb_hostel_reg.reg_phase = '$phase_id'") or die(mysqli_error());
